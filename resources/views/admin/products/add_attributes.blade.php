            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <form action="{{ url('admin/edit-attributes/'.$productDetails->id) }}" method="post" name="edit_attributes" id="edit_attributes">
                                {{ csrf_field() }}
                                ...
                                @foreach($productDetails['attributes'] as $attribute)
                                    <tr class="gradeX">
                                        ...
                                        <td class="center">
                                            ...
                                            <a href="javascript:" class="btn btn-danger btn-mini del-attribute" rel="{{ $attribute->id }}" rel1="delete-attribute">Delete</a></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
